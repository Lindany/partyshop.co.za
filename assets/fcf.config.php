...
// EMAIL MESSAGE
// *************
define('EMAIL_TO', 'info@partyshoppe.co.za');
define('EMAIL_TO_NAME', 'partyshoppe');
...
define('EMAIL_FROM', 'info@partyshoppe.co.za');
...
define('SMTP_USER', 'info@partyshoppe.co.za');
define('SMTP_PASS', 'info@partyshoppe.co.za');
define('SMTP_AUTH', '');
